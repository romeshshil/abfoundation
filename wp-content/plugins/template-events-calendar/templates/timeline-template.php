<?php
		...
		$event_img.=tribe_event_featured_image($event_id, null, 'full' );	
 		if ($i % 2 == 0) {
				$even_odd = "even";
				} else {
				$even_odd = "even";
			...
			$events_html .= '<div class="timeline-year">
				...
				$events_html.='<div id="post-'.$event_id.'" class="timeline-post '.$even_odd.' '.$event_type.' '.$post_parent.' '.$template.'-evt">';
